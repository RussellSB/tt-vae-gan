...
def batch_wavegen(model, c=None, g=None, fast=True, tqdm=tqdm):
    ...
    c = None if c is None else torch.from_numpy(_to_numpy(c))  # added
...
if __name__ == "__main__":
    ...
    # DO generate
    waveform = batch_wavegen(model, c=c, g=speaker_id, fast=True)  # edited to right params
    # save
